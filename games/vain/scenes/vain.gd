...
func initialise_global_queue():
	Queue.queue.append({"type": "wait", "parameters": 0.5})
	Queue.queue.append({"type": "change_background", "parameters": null})
	Queue.queue.append({"type": "fade_in", "parameters": {"wait": true}})
	...
	Queue.queue.append({"type": "wait", "parameters": 1})
	Queue.queue.append({"type": "generate_portrait", "parameters": null})
	Queue.queue.append({"type": "wait", "parameters": 1})
	
	Queue.queue.append({"type": "generate_story", "parameters": null})
	# TODO: Play applause
	...
	Queue.queue.append({"type": "wait", "parameters": 1.5})
	Queue.queue.append({"type": "fade_out", "parameters": {"wait": true}})
